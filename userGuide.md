...
<table>
  <tr>
    <td style="border:0px solid #eee;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td style="border:0px solid #eee;"><h1>TicketPad</h1></td>
    <td style="border:0px solid #eee;">&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td style="border:0px solid #eee;"><img src="images/iY_full.svg" alt="Icon" style="margin:0px; padding:0px; border:0px solid #eee; border-radius:8px; box-shadow: 6px 6px 12px rgba(0,0,0,0.3); max-width:80px;" /></td>
  </tr>
</table>
...
<center>
<img src="images/options.png" alt="Options Dialog"
     style="margin:30px; padding:1px; border:1px solid #eee; border-radius:8px; box-shadow: 6px 6px 12px rgba(0,0,0,0.3); max-width:300px;" />
</center>
